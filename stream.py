...
def stream_movie(movie):
    ...
    -filter_complex "[1:v]scale=w=iw:h=ih[ovr];[ovr]scale=w=main_w:h=main_h[scaled_ovr];[0:v][scaled_ovr]overlay=0:0,drawtext=text='{}':fontcolor=white:fontsize=24:x=20:y=20" \
